...
const Hero = () => {
  ...
  const downloadScript = () => {
    ...
    element.download = "ubuntu-dev-setup.sh";
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-4 py-20">
      ...
      <div className="absolute inset-0 bg-gradient-subtle">
        ...
        <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-accent/10 rounded-full blur-3xl animate-pulse-slow" style={{ animationDelay: "2s" }} />
      </div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-card border border-primary/20 mb-8 animate-float">
          ...
          <span className="text-sm text-muted-foreground">Zero-config Ubuntu dev environment</span>
        </div>
        ...
        <p className="text-xl text-muted-foreground mb-12 max-w-2xl mx-auto">
          Bootstrap your Ubuntu workstation with everything you need: languages, tools, databases, cloud CLIs, 
          GUI apps, and AI stack. Safe to re-run, WSL-aware.
        </p>

        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
          <Button 
            size="lg" 
            className="bg-gradient-primary hover:opacity-90 text-primary-foreground glow-primary text-lg px-8 py-6"
        ...
        {/* Terminal window */}
        <div className="terminal-window max-w-3xl mx-auto text-left">
          <div className="flex items-center gap-2 px-4 py-3 border-b border-border">
            ...
            <span className="text-xs text-muted-foreground ml-2">ubuntu-dev-setup.sh</span>
          </div>
          <div className="p-6 font-mono text-sm overflow-x-auto">
            <div className="flex items-start gap-3">
              <span className="text-accent select-none">$</span>
              <code className="text-foreground flex-1">{installCommand}</code>
              <button
                onClick={copyToClipboard}
        ...
        <div className="mt-8 text-sm text-muted-foreground">
          Works on Ubuntu 20.04+ • WSL2 compatible • Safe to re-run
        </div>
      </div>
    </section>
  );
...
// Script content (improved version)
